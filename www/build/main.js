...
var PedidosServiceProvider = /** @class */ (function () {
    function PedidosServiceProvider(http) {
        this.http = http;
    }
    PedidosServiceProvider.prototype.getPedidos = function () {
        var _this = this;
        if (typeof (this.estoque) === 'undefined') {
            return this.http.get('../../assets/files/estoque.json')
                .toPromise().then(function (res) {
                _this.estoque = res;
                return _this.estoque;
            });
        }
        else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lista_pedidos_lista_pedidos__ = __webpack_require__(99);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.listaPedidos = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__lista_pedidos_lista_pedidos__["a" /* ListaPedidosPage */].name);
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\home\home.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n\n\n    <ion-buttons left>\n\n      <button ion-button icon-only clear menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n\n\n    <ion-title>Home</ion-title>\n\n\n\n    <ion-buttons end>\n\n      <button (click)="listaPedidos()" ion-button icon-only clear>\n\n        <ion-icon name="cart"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\home\home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pedido_pedido__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_pedidos_service_pedidos_service__ = __webpack_require__(154);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CadastroPedidosPage = /** @class */ (function () {
    function CadastroPedidosPage(navCtrl, navParams, pedServ) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.pedServ = pedServ;
    }
    CadastroPedidosPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.pedServ.getPedidos().then(function (estoque) {
            console.log(estoque);
    ...
    CadastroPedidosPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__providers_pedidos_service_pedidos_service__["a" /* PedidosServiceProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_pedidos_service_pedidos_service__["a" /* PedidosServiceProvider */]) === "function" && _c || Object])
    ], CadastroPedidosPage);
...
var ListaClientesPage = /** @class */ (function () {
    ...
    ListaClientesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-lista-clientes',template:/*ion-inline-start:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\lista-clientes\lista-clientes.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Clientes</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\lista-clientes\lista-clientes.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_pedidos_service_pedidos_service__ = __webpack_require__(154);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["c" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* MyApp */], { StatusBarPadding: true }, {
                    links: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__providers_pedidos_service_pedidos_service__["a" /* PedidosServiceProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_home_home__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_lista_clientes_lista_clientes__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_lista_fornecedores_lista_fornecedores__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_lista_pedidos_lista_pedidos__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_cadastro_pedidos_cadastro_pedidos__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_settings_settings__ = __webpack_require__(204);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.statusBar.backgroundColorByHexString('#0f7de1');
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\list\list.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>List</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-list>\n\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n\n      {{item.title}}\n\n      <div class="item-note" item-end>\n\n        {{item.note}}\n\n      </div>\n\n    </button>\n\n  </ion-list>\n\n  <div *ngIf="selectedItem" padding>\n\n    You navigated here from <b>{{selectedItem.title}}</b>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\list\list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], ListPage);
    return ListPage;
...
var ListaPedidosPage = /** @class */ (function () {
    ...
    ListaPedidosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-lista-pedidos',template:/*ion-inline-start:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\lista-pedidos\lista-pedidos.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Pedidos</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\silas.naves\Documents\ionic\lucmar-app\src\pages\lista-pedidos\lista-pedidos.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], ListaPedidosPage);
